...
CONTACT_PHONE = os.getenv("CONTACT_PHONE", "+7 995 028-29-40")
...
EXECUTOR_ADDRESS = os.getenv("EXECUTOR_ADDRESS", "Волгоград, Полоненко 10")
...
TINKOFF_TERMINAL_KEY = os.getenv("TINKOFF_TERMINAL_KEY") or os.getenv("TINKOFF_TERMINAL")
TINKOFF_PASSWORD = os.getenv("TINKOFF_PASSWORD") or os.getenv("TINKOFF_SECRET")
