...
_RATE_LIMIT = {
    "apply": {"daily": 5, "burst": 1, "window": 10},
    "enroll": {"daily": 3, "burst": 1, "window": 10},
}
_rate_daily: dict[tuple[str, str], dict[str, int]] = {}
