...
HOME_MARKETING: Dict[str, Any] = {
    ...
    "teachers_showcase": {
        ...
        "title": "Преподаватель, у которого вы реально учитесь",
        "description": (
            "Оставили один финальный формат с большим фото: он лучше всего показывает человека, экспертизу и "
            "ощущение личного сопровождения."
        ),
        "note": "",
        "cards": [
            {
                ...
                "lead": "Сильный формат, когда нужно показать преподавателя как лицо маршрута, а не просто подпись под курсом.",
                "bio": (
                    "Крупный портрет делает секцию статусной и живой. Сюда можно просто подставить реальное фото, "
                    "и блок сразу будет выглядеть как финальная продуктовая подача, а не как тестовый showcase."
                ),
